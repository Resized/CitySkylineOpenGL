	...
	double vertical_shift, double buildingWidth, double sampleFreq, double drawBuildingShift)
{
	...
	{
		y = vertical_shift + fabs(s_amp * sin(s_phase + s_freq * x) + c_amp * cos(c_phase + c_freq * x));
		drawSingleBackBuilding(x, y, buildingWidth);
	}
}

void drawSingleBackBuilding(double x, double y, double w)
{
	glColor3d(0.2, 0, 0.2);
	glBegin(GL_POLYGON);
	glVertex2d(x, y); // 1
...
void display()
{
	...
	drawBackSkyline(s_freq, s_amp, s_phase, c_freq, c_amp, c_phase, vertical_shift, buildingWidth, sampleFreq, drawBuildingShift);
	...
	drawSkyline(s_freq, s_amp, s_phase, c_freq, c_amp, c_phase, vertical_shift, buildingWidth, sampleFreq, drawBuildingShift); // Background Buildings
	...
	drawSkyline(s_freq, s_amp, s_phase, c_freq, c_amp, c_phase, vertical_shift, buildingWidth, sampleFreq, drawBuildingShift);
